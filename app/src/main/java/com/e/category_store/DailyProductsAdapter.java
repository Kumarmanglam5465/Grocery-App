...
public class DailyProductsAdapter extends RecyclerView.Adapter<DailyProductsAdapter.ViewHolder> {
    ...
    public DailyProductsAdapter(FragmentActivity activity) {
        c=activity;
    }

    @NonNull
    @Override
    public DailyProductsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final DailyProductsAdapter.ViewHolder holder, final int position) {
